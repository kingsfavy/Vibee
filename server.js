...
app.get('/reset-password', (req, res) => res.sendFile(__dirname + '/public/pages/reset-password.html'));
app.get('/forgot-password', (req, res) => res.sendFile(__dirname + '/public/pages/forgot-password.html'));
app.get('/profile', ensureAuthenticated, (req, res) => res.sendFile(__dirname + '/public/pages/profile.html'));
app.get('/dashboard', ensureAuthenticated, (req, res) => res.sendFile(__dirname + '/public/pages/dashboard.html'));
app.get('/mobile-dashboard', ensureAuthenticated, (req, res) => res.sendFile(__dirname + '/public/pages/mobile-dashboard.html'));
app.get('/mobile-news', ensureAuthenticated, (req, res) => res.sendFile(__dirname + '/public/pages/mobile-news.html'));
app.get('/mobile-online', ensureAuthenticated, (req, res) => res.sendFile(__dirname + '/public/pages/mobile-online.html'));
app.get('/chat', ensureAuthenticated, (req, res) => res.sendFile(__dirname + '/public/pages/chat.html'));
